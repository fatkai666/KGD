...
var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: 'kgd-upload-list' }, fileList.map(function (item) { return (React.createElement("li", { className: 'kgd-upload-list-item', key: item.uid },
        React.createElement("span", { className: "file-name file-name-" + item.status },
            React.createElement(Icon, { icon: 'file-alt', theme: 'secondary' }),
            item.name),
        React.createElement("span", { className: 'file-status' }, item.status === 'uploading' || item.status === 'ready' ?
